...
<body>
  ...
  <li class="nav-item">
    <a class="nav-link active" href="add_question.php">Add Question</a>
  </li>
  <li class="nav-item">
...
<div class="row"><div class="col-sm-1"></div>
		...
		<div class="row">
		<div class="col-sm-1"></div><div class="col-sm-3 font-weight-bolder">Answer:</div><div class="col-sm-6"><input type="text" class="form-control" id="inputEmail3" placeholder="Answer" name="answer"></div></div><br>

		<div class="row">
		<div class="col-sm-1"></div><div class="col-sm-3 font-weight-bolder">Option 1:</div><div class="col-sm-6"><input type="text" class="form-control" id="inputEmail3" placeholder="Option 1" name="option1"></div></div><br>

		<div class="row">
		<div class="col-sm-1"></div><div class="col-sm-3 font-weight-bolder">Option 2:</div><div class="col-sm-6"><input type="text" class="form-control" id="inputEmail3" placeholder="Option 2" name="option2"></div></div><br>

		<div class="row">
		<div class="col-sm-1"></div><div class="col-sm-3 font-weight-bolder">Option 3:</div><div class="col-sm-6"><input type="text" class="form-control" id="inputEmail3" placeholder="Option 3" name="option3"></div></div><br>

		<div class="row">
		<div class="col-sm-1"></div><div class="col-sm-3 font-weight-bolder">Points:</div><div class="col-sm-6"><input type="text" class="form-control" id="inputEmail3" placeholder="Points" name="points"></div></div><br>
		<div class="row">
		<div class="col-sm-1"></div><div class="col-sm-3 font-weight-bolder"></div><div class="col-sm-6"><div class="form-check">
        <input class="form-check-input" type="checkbox" id="gridCheck1" name="tie" value="1">
        <label class="form-check-label" for="gridCheck1">
          Tie Breaker?
        </label>
      </div><br>
		<div class="row">
		<div class="col-sm-1 ml-auto"><button type="submit" class="btn btn-primary" name="submit" value="update">Add</button></div>
      </div>
